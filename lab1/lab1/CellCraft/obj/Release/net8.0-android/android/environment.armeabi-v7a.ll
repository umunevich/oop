...
@dso_cache = dso_local local_unnamed_addr global [540 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 510934884, ; hash 0x1e743f64, from name: aot-Calculator
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 548016677, ; hash 0x20aa1225, from name: aot-Antlr4.Runtime.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 949512580, ; hash 0x38986984, from name: aot-Antlr4.Runtime
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Antlr4.Runtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 109
	...
	%struct.DSOCacheEntry {
		i64 976506700, ; hash 0x3a344f4c, from name: CellCraft
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1459344182, ; hash 0x56fbd336, from name: libaot-Calculator.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculator.dll.so
		ptr null; void* handle (0x0)
	}, ; 181
	...
	%struct.DSOCacheEntry {
		i64 1583841206, ; hash 0x5e677fb6, from name: aot-CellCraft
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CellCraft.dll.so
		ptr null; void* handle (0x0)
	}, ; 194
	...
	%struct.DSOCacheEntry {
		i64 1653983261, ; hash 0x6295c81d, from name: Calculator
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculator.dll.so
		ptr null; void* handle (0x0)
	}, ; 204
	...
	%struct.DSOCacheEntry {
		i64 1811728891, ; hash 0x6bfcc9fb, from name: libaot-Antlr4.Runtime
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Antlr4.Runtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 226
	...
	%struct.DSOCacheEntry {
		i64 2156039053, ; hash 0x80828b8d, from name: libaot-CellCraft
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CellCraft.dll.so
		ptr null; void* handle (0x0)
	}, ; 269
	...
	%struct.DSOCacheEntry {
		i64 2260136676, ; hash 0x86b6f2e4, from name: libaot-CellCraft.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CellCraft.dll.so
		ptr null; void* handle (0x0)
	}, ; 286
	...
	%struct.DSOCacheEntry {
		i64 2364693779, ; hash 0x8cf25d13, from name: Antlr4.Runtime.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Antlr4.Runtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 301
	...
	%struct.DSOCacheEntry {
		i64 2401262781, ; hash 0x8f205cbd, from name: CellCraft.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CellCraft.dll.so
		ptr null; void* handle (0x0)
	}, ; 307
	...
	%struct.DSOCacheEntry {
		i64 2846585564, ; hash 0xa9ab72dc, from name: libaot-Calculator
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculator.dll.so
		ptr null; void* handle (0x0)
	}, ; 372
	...
	%struct.DSOCacheEntry {
		i64 2974851052, ; hash 0xb1509fec, from name: aot-CellCraft.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CellCraft.dll.so
		ptr null; void* handle (0x0)
	}, ; 390
	...
	%struct.DSOCacheEntry {
		i64 3046284523, ; hash 0xb5929ceb, from name: Calculator.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculator.dll.so
		ptr null; void* handle (0x0)
	}, ; 401
	...
	%struct.DSOCacheEntry {
		i64 3297384340, ; hash 0xc48a1794, from name: libaot-Antlr4.Runtime.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Antlr4.Runtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 435
	...
	%struct.DSOCacheEntry {
		i64 3479596330, ; hash 0xcf666d2a, from name: Antlr4.Runtime
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Antlr4.Runtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 452
	...
	%struct.DSOCacheEntry {
		i64 3948284154, ; hash 0xeb5608fa, from name: aot-Calculator.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Calculator.dll.so
		ptr null; void* handle (0x0)
	}, ; 503
